...
-export([increment_vclock/4, prune_vclock/3, vclock_descends/2, all_actors/1]).
...
-export([merge/4, apply_updates/1, syntactic_merge/3]).
...
increment_vclock(Object, ClientId, undefined_timestamp, DVVEnabled) ->
...
update(false, OldObject, NewObject, Actor, Timestamp, DVVEnabled) ->
    ...
    case vclock:descends(PutVC, LocalVC) of
        ...
        false ->
            ...
            MergedObject = merge(DottedPutObject, OldObject, DVVEnabled, not_write_once), %% FIXME
